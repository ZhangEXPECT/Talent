 ...
 **/
// 用户管理-获取用户列表
export const userList = (params) => { return req("post", "/user/getUser", params) };
// 用户管理-Id查询
export const getUserById = (params) => { return axios.get("get", "/user/queryId/"+params) };
// 用户管理-删除用户
export const userDelete = (params) => { return axios.get("get", "/user/delete/"+ params) };
// 用户管理-重置密码
export const userPwd = (params) => { return req("post", "/user/updatePwd", params) };
// 用户管理-编辑
export const updateUser = (params) => { return req("post", "/user/update", params)};


export const userSave = (params) => { return req("post", "/user/update", params)};
export const userLock = (params) => { return req("post", "/user/update", params)};
// 用户管理-数据权限
