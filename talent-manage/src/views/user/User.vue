        ...
        <el-form :inline="true" :model="formInline" class="user-search">
            <el-form-item label="搜索：">
                <el-select size="small" v-model="formInline.isLock" placeholder="请选择">
                    ...
                    <el-option label="已认证" value="N"></el-option>
                    <el-option label="未认证" value="Y"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="">
        ...
        <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading"
            ...
            <el-table-column align="center" prop="avatar" label="用户头像" width="120">
                <template slot-scope="scope">
                    <el-image :src="scope.row.avatar" fit="fill" :lazy="true"></el-image>
                </template>
            </el-table-column>
            <el-table-column align="center" prop="nick" label="用户名" width="120">
            </el-table-column>
            ...
            <el-table-column align="center" sortable prop="idcard" label="身份证号" min-width="150">
            </el-table-column>
            ...
            <el-table-column align="center" sortable prop="certified" label="状态" min-width="80">
                <template slot-scope="scope">
                    <div v-if="scope.row.certified == '是'">已认证</div>
                    <div v-else>未认证</div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="操作" min-width="350">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="success" @click="offlineUser(scope.$index, scope.row)">修改状态</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页组件 -->
