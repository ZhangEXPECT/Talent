<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>入住申请</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- 搜索筛选 -->
        ...
        <!--列表-->
        <el-table size="small" @selection-change="selectChange" :data="checkData" highlight-current-row
            v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
            <el-table-column align="center" type="selection" width="50">
            </el-table-column>
            <el-table-column align="center" sortable prop="checkId" label="预约编号" width="100">
            </el-table-column>
            ...
            <el-table-column align="center" sortable prop="checkTime" label="入住时间" min-width="150">
            </el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
            <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
                <el-form-item label="入住状态" prop="status">
                    <el-input size="small" v-model="editForm.status" auto-complete="off" placeholder="入住完成填入已结束"></el-input>
                </el-form-item>
            </el-form>
...
// 导入请求方法
import {
    addCheck, updateCheck, getCheck, getAllCheck, deleteCheck
    ...
    methods: {
        ...
        handleEdit: function (index, row) {
            ...
            if (row != undefined && row != 'undefined') {
                ...
                this.editForm.checkId = row.checkId
            } else {
                // this.title = '添加用户'
